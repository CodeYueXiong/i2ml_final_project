...
### 1.2 Defining response variable
...
#### 1.6.1 Missing pattern and missing data mechanism
...
#### 1.6.3 Multiple imputation with MICE package
...
#### 1.6.4 Multiple imputation with missForest package
