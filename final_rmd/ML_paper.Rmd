...
+---------------+-----------------------+--------------------+---------------------+-------------------------+
|     Models    |  Logistic Regerssion  |        KNN         |         SVM         |      Random Forest      |
+===============+=======================+====================+=====================+=========================+
|  Default Auc  |         0.7248        |       0.7143       |        0.5218       |          0.7643         |
+---------------+-----------------------+--------------------+---------------------+-------------------------+
|   Over. Auc   |         0.7236        |       0.7594       |         N/A         |           N/A           |
+---------------+-----------------------+--------------------+---------------------+-------------------------+
|  Over.ratio   |         30            |         25         |         N/A         |           N/A           |
+---------------+-----------------------+--------------------+---------------------+-------------------------+
|   Smote Auc   |         0.7253        |       0.7730       |        0.7839       |          0.8321         |
+---------------+-----------------------+--------------------+---------------------+-------------------------+
| Smote.K       |         15            |         15         |         21          |           15            |
| Smote.dup_size|         31            |         40         |         40          |           45            |
+---------------+-----------------------+--------------------+---------------------+-------------------------+
| Model Para.   |         None          |        k=40        |     cost=0.1        |        mtry=7           |
|               |                       |     distance=3     |    gamma=0.75       |    num.trres=1000       |
|               |                       |  kernel=triangular |   kernel=radial     |    min.node.size=3      |
