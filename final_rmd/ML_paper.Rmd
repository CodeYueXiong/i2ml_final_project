...
lg_smote_auto <- AutoTuner$new(
  ...
  terminator = terms, tuner = tnr("grid_search", lution = 5)
)
...
knn_auto <- AutoTuner$new(learner = lrn_over, resampling = inner_rsmp, 
                          ...
                          terminator = terms, tuner = tnr("grid_search", lution = 6))
...
knn_auto <- AutoTuner$new(learner = lrn_smote, resampling = inner_rsmp, 
                          measures = msr("classif.auc"), tune_ps = knn_param_set,
                          terminator = terms, 
                          tuner = tnr("grid_search", lution = 6))
...
svm_auto_smote <- AutoTuner$new(
  ...
  terminator = term("none"), tuner = tnr("grid_search", lution = 5)
)
```
...
svm_auto_smote <- AutoTuner$new(
  ...
  terminator = term("none"), tuner = tnr("grid_search", lution = 3)
)
```
