...
As for **classbalancing**, *oversample.ratio* is the hyperparamter we must set, ranging from 10 to 70.
...
```{r echo=FALSE,out.width = "100%", fig.pos="h"}
knitr::include_graphics("img/over_lg.png")
```

shown on the plots above, it is better to choose *oversample.ratio* with value 
