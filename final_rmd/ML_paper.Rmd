...
```{r}
library(mlr3)
# create task for all the data
# create task without dm
task_all <- list(
...
set.seed(2020)
#create benchmark
rf_over_bmr <- benchmark(rf_over_design, store_models = TRUE)
#aggregate to get results of model
...
over_gg3 <- ggplot(over_path3, aes(
  ...
  geom_point(size = 3) +
  geom_line() #+ theme(legend.position = "none")
# load the required package required for plotting
library(ggpubr)
ggarrange(over_gg1, over_gg2, over_gg3, common.legend = TRUE, legend = "bottom")
```
